...
NS_RETURNS_RETAINED static MutableOrderedDictionary*
...
@implementation JsonSerializationCustom
+ (void) initialize
{
                    ...
                    error: (NSError **)error
{
  ...
  p.mutableContainers
    = (opt & NSJSONReadingMutableContainers1) == NSJSONReadingMutableContainers1;
  p.mutableStrings
