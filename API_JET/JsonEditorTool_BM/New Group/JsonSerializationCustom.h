...
enum
{
   ...
   */
  NSJSONReadingMutableContainers1 = (1UL << 0),
  /**
   * Strings in a JSON tree will be mutable.
   */
  NSJSONReadingMutableLeaves1     = (1UL << 1),
  /**
   * The parser will read a single value, not just a
   */
  NSJSONReadingAllowFragments1    = (1UL << 2)
};
enum
{
  /**
 ...
 * graphs in JSON.
 */
@interface JsonSerializationCustom : NSObject
